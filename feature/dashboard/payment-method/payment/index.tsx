      ...
      <div className="w-full max-w-lg">
        <div className="">
          ...
          <div className="flex gap-3 mt-8">
            <button className="flex-1 py-4 bg-neutral-800 text-neutral-300 rounded-xl font-semibold hover:bg-neutral-700 transition">
              Cancel
            </button>
            <button className="flex-1 py-4 bg-[#1A5FA4] text-white rounded-xl font-semibold transition">
              Submit
            </button>
          </div>
        </div>
